        ...
        <div className="row gy-4">
          <div className="col-md-4">
            ...
            <p className="text-secondary">
              Connecting top talent with the best opportunities, plus a personal WhatsApp job feed.
            </p>
          </div>
          ...
          <div className="col-md-4">
            ...
            <ul className="list-unstyled mb-0 d-flex flex-column gap-2">
              ...
              <li><Link to="/whatsapp" className="text-decoration-none text-secondary custom-hover">WhatsApp Feed</Link></li>

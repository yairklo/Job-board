  ...
  return (
    <nav className="navbar navbar-expand-md bg-body-tertiary border-bottom sticky-top">
      <div className="container">
        ...
        {/* Mobile Toggle & Theme button outside collapse for easy access */}
        <div className="d-flex d-md-none align-items-center">
          <button onClick={toggleTheme} className="btn btn-link text-secondary p-1 me-2">
            {isDarkMode ? <FiSun size={24} /> : <FiMoon size={24} />}
          </button>
          <button onClick={() => setIsOpen(!isOpen)} className="navbar-toggler border-0 p-1" type="button">
        ...
        <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`}>
          ...
          <div className="d-flex align-items-center gap-3">
            <button onClick={toggleTheme} className="btn btn-link text-secondary p-0 d-none d-md-block">
